...
const Pause = React.memo((props: any) => (
...
const Play = React.memo((props: any) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor"
...
const Logo = React.memo((props: any) => (
...
const Pencil = React.memo((props: any) => (
...
const Down = (props: any) => (<svg xmlns="http://www.w3.org/2000/svg" width={props.width || '47'}
  height={props.height || '47'} fill="currentColor" className="bi bi-arrow-down" viewBox="0 0 16 16">
  <path fillRule="evenodd" d="M8 1a.5.5 0 0 1 .5.5v11.793l3.146-3.147a.5.5 0 0 1 .708.708l-4 4a.5.5 0 0 1-.708 0l-4-4a.5.5 0 0 1 .708-.708L7.5 13.293V1.5A.5.5 0 0 1 8 1z"/>
</svg>)

export default { Pause, Play, Logo, Pencil, Save, Plus, Inside, Star, List, Remove, Shuffle, Down };
